    ...
    public static String GetNetworkType(Context mContext)
    {
        ...
        if (networkInfo != null && networkInfo.isConnected())
        {
            ...
            else if (networkInfo.getType() == ConnectivityManager.TYPE_MOBILE)
            {
                ...
                Log.e("BLTool", "Network getSubtypeName : " + _strSubTypeName);
                ...
                Log.e("BLTool", "Network getSubtype : " + Integer.valueOf(networkType).toString());
            }
        }

        Log.e("BLTool", "Network Type : " + strNetworkType);
